    ...
    <div className={`min-h-screen transition-colors duration-500 bg-background text-foreground`}>
      ...
      <main className="pt-20 pb-15">
        <section className="relative py-12 lg:py-16 bg-gradient-to-b from-secondary to-background border-b border-border mb-12 lg:mb-16">
          <div className="max-w-7xl mx-auto px-6">
            ...
            <motion.div
              ...
              className="text-left"
            >
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-[#F24C20]/10 border border-[#F24C20]/20 text-[#F24C20] text-[10px] font-black uppercase tracking-[0.2em] mb-4">
        ...
        <div className="max-w-7xl mx-auto px-2">
          {/* Search & Filter */}
          <div className="max-w-4xl mx-auto mb-5 lg:mb-5">
