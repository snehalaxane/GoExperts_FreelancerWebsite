        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
            <div>
                <motion.h1 
                    ...
                    className={`text-2xl sm:text-3xl md:text-2xl font-black tracking-tight flex flex-wrap items-center gap-2 sm:gap-4 ${isDarkMode ? 'text-white' : 'text-neutral-900'}`}
                >
            ...
            <div className="flex items-center gap-2 sm:gap-3 w-full md:w-auto">
                <button 
                   onClick={fetchData}
                   className={`p-2.5 sm:p-3 rounded-2xl border transition-all ${isDarkMode ? 'bg-neutral-900 border-neutral-800 text-neutral-400 hover:text-gray-800' : 'bg-white border-neutral-200 text-gray-600 hover:bg-neutral-50'}`}
                >
