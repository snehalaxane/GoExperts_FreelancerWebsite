        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
            <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }}>
                <div className="flex flex-wrap items-center gap-3">
                    <h1 className={`text-2xl sm:text-2xl font-black tracking-tight ${isDarkMode ? 'text-white' : 'text-neutral-900'}`}>
            ...
            <div className="flex items-center gap-3">
                {/* <button 
                   onClick={fetchData}
                   className={`p-3 rounded-2xl border transition-all ${isDarkMode ? 'bg-neutral-900 border-neutral-800 text-gray-400 hover:text-gray-800' : 'bg-white border-neutral-200 text-neutral-600 hover:bg-neutral-50'}`}
                >
