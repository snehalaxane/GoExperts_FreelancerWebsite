        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <motion.button
              ...
              className="group flex items-center gap-1 px-2 py-3 bg-[#044071] hover:bg-[#055a99] text-white font-black uppercase tracking-widest rounded-2xl transition-all shadow-lg shadow-[#044071]/30 border border-[#044071]"
            >
              {buttonText}
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-2 gap-1 sm:gap-4">
                        <h3 className="text-base sm:text-lg font-black text-foreground uppercase tracking-tight  truncate sm:whitespace-normal">
                          {item.role}
                        </h3>
