    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4">
        ...
        >
          ...
          >
            <div className="px-5 py-1 rounded-full bg-[#F24C20]/10 border border-[#F24C20]/30 backdrop-blur-sm">
        ...
        <div className="relative max-w-5xl mx-auto">
          <AnimatePresence mode="wait">
            ...
            >
              {/* Large Quote Card */}
              <div className="relative p-9 md:p-4 rounded-4xl bg-white border border-[#FFE0C2] overflow-hidden shadow-xl shadow-orange-500/5">
                {/* Quote Icon */}
                <motion.div
                ...
                <div className="relative">
                  ...
                  <motion.p
                    ...
                    className="text-2xl md:text-xl text-foreground font-medium leading-relaxed mb-4 text-center max-w-3xl mx-auto"
                  >
