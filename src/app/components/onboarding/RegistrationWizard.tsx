...
function PhoneNumberField({
  ...
  return (
    <div className="relative">
      <label className="mb-1.5 block text-xs font-bold text-gray-900">{label}</label>
      <div
      ...
      >
        ...
        <div className="relative flex-1">
          <input
            ...
            className="w-full placeholder:text-[12px] bg-transparent py-3 pl-4 pr-4 text-sm font-normal text-white placeholder:text-[12px] placeholder:font-normal placeholder:text-neutral-500 focus:outline-none"
          />
        </div>
      </div>
                      ...
                      {step.type === 'account-creation' && (
                        <div className="space-y-5">
                          <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
                            <div>
                              <label className="mb-1.5 block text-xs font-semibold text-neutral-200">Full Name</label>
                              <div className="relative">
                                ...
                                <input
                                  ...
                                  className="w-full rounded-xl border-2 border-[#F24C20]/40 bg-neutral-950 py-3 pl-10 pr-4 text-sm text-white placeholder:text-[12px] placeholder:font-normal placeholder:text-neutral-500 focus:outline-none focus:border-[#F24C20] transition-colors"
                                />
                              </div>
                            </div>
                            <div>
                              <label className="mb-1.5 block text-xs font-semibold text-neutral-200">Password</label>
                              <div className="relative">
                          ...
                          <div>
                            <label className="mb-1.5 block text-xs font-bold text-gray-900">Email Address</label>
                            <div className="relative">
                              ...
                              <input
                                ...
                                className={`w-full rounded-xl border-2 bg-neutral-950 py-3 pl-10 pr-4 text-sm text-white placeholder:text-[12px] placeholder:font-normal placeholder:text-neutral-500 focus:outline-none transition-colors ${data.email && !/^[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$/.test(data.email) ? 'border-red-500/50 focus:border-red-500' : 'border-[#F24C20]/40 focus:border-[#F24C20]'}`}
                              />
                            </div>
                            <p className="mt-1.5 text-[12px] text-neutral-500">We'll send a verification link to this email.</p>
                          </div>
                        </div>
                      )}
                    </motion.div>
