...
export default function AllCategoriesPage() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      {/* Hero Section */}
      <section className="relative py-12 lg:py-16 bg-gradient-to-b from-secondary to-background border-b border-border mb-12 lg:mb-16 overflow-hidden">
        {/* Animated Background */}
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6">
          ...
          >
           ...
           <h1 className="text-5xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-gray-900 via-gray-800 to-orange-600 bg-clip-text text-transparent">
